...
txt_file_path = r'D:/work/Yolo-FastestV2-main/shujuji/焊后检测/另一种版型/test/labels'  # 原始的标签路径
save_file_path = r'D:/work/Yolo-FastestV2-main/shujuji/焊后检测/另一种版型/test/labels1'  # 修改后的标签路径
